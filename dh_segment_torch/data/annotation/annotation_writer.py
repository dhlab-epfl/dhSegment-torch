...
from dh_segment_torch.data.annotation.annotation_reader import (
    AnnotationIterator,
    AnnotationReader,
)
...
class AnnotationWriterDataset(Dataset):
    def __init__(
        self,
...
class AnnotationWriter(Registrable):
    ...
    def __init__(
        ...
        self.annotation_dataset_writer = AnnotationWriterDataset(
            annotation_iterator,
            annotation_painter,
            labels_dir,
            images_dir,
...
AnnotationWriter.register("default", "from_reader")(AnnotationWriter)
